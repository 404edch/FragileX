    ...
    <div style={{ padding: '24px' }}>
      ...
      <div style={{
        ...
        <div style={{ flex: '1 1 250px' }}>
          <label style={{ display: 'block', fontSize: '12px', fontWeight: 'bold', color: '#718096', marginBottom: '6px', textTransform: 'uppercase' }}>Buscar</label>
          <input
            type="text"
        ...
        <div style={{ width: '180px' }}>
          <label style={{ display: 'block', fontSize: '12px', fontWeight: 'bold', color: '#718096', marginBottom: '6px', textTransform: 'uppercase' }}>Perfil</label>
          <select
            className="cadastro-input"
            value={roleFilter}
        ...
        <div style={{ width: '180px' }}>
          <label style={{ display: 'block', fontSize: '12px', fontWeight: 'bold', color: '#718096', marginBottom: '6px', textTransform: 'uppercase' }}>Status</label>
          <select
            className="cadastro-input"
            value={statusFilter}
          ...
          <tbody>
            {filteredUsers.length === 0 ? (
              ...
              filteredUsers.map((u, i) => (
                <tr key={u.id} style={{ borderBottom: i < filteredUsers.length - 1 ? '1px solid #edf2f7' : 'none' }}>
            ...
            <form onSubmit={handleSaveEdit} style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {editRole === 'medico' && (
                <div style={{
                  ...
                  <h4 style={{ fontSize: '14px', fontWeight: 'bold', color: '#4a5568', margin: 0 }}>
