    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
      ...
      <div>
        ...
        <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.85)' }}>
          Acompanhe os resultados dos checklists de pré-triagem preenchidos pelos médicos.
        </p>
      </div>
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
                  <div>
                    ...
                    <span style={{ fontSize: '12px', color: '#64748b' }}>
                      Preenchido por: {notif.preenchido_por}
                    </span>
                  </div>
                  <span style={{
                    fontSize: '11px',
                ...
                <div style={{
                  ...
                  <div style={{ padding: '0 8px' }}>
                    ...
                    {notif.score_final.toFixed(2)} pts
                  </div>
                  <div style={{ padding: '0 8px' }}>
              ...
              >
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: '12px', color: '#94a3b8' }}>
                    Por: {notif.preenchido_por} | Score: {notif.score_final.toFixed(2)} pts | {formatarData(notif.created_at)}
                  </p>
                </div>
                <span style={{
                  fontSize: '11px',
